...
<form method="post" action="<?php $uri = & JFactory::getURI(); echo $uri->toString() ?>" class="form-validate">
        ...
        <div class="contactme-row">
            <label><?php echo JText::_('MOD_CONTACTME_EMAIL')?>
                <input type="text" name="mailfrom" class="mail" placeholder="<?php echo JText::_('MOD_CONTACTME_EMAIL_PLACE')?>" />
            </label>
        </div>
        <div class="contactme-row">
